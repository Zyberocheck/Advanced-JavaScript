...
//       throw new Error('Такой массив уже существует!');
//     }
...
// const liba = new Library(['Му-Му', 'Война и Мир', 'Метро 2033', 'Ведьмак']);
// console.log(liba.allBooks);

// liba.addBook('Лунтик');
// console.log(liba.allBooks);

// liba.removeBook('Сталкер');
